            ...
            <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-6 mt-3 mb-3">
                    <div class="form-group">
                        <strong>Name</strong>
                        <input type="text" name="name" value="{{ $data->name }}" class="form-control" placeholder="Tag Name">
                    </div>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-6 mt-3 mb-3">
                    <div class="form-group">
                        <strong>Slug</strong>
                        <input type="text" name="email" value="{{ $data->slug }}" class="form-control" placeholder="Advertiser Email">
                    </div>
                </div>
            </div>
            <div class="row">
